...
$orders = query("SELECT * FROM pesanan WHERE tanggal = CURDATE() AND statuspesanan != 'selesai' ");
?>
  ...
  <body class="bg-cyan-700">
    <div class="bg-white flex p-5">
      ...
      <ul class="flex flex-1 justify-end gap-10">
        <li>
          <a class="text-red-500" href="admin_dash.php">Daftar Pesanan</a>
        </li>
        <li>
          <a class="hover:text-red-500" href="admin_riwayat.php"
            >Riwayat Pesanan</a
          >
        </li>
        <li>
...
<div class="w-full flex justify-end">
    <button type="submit" name="submit"
      class="text-white hover:text-white border border-white hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 mt-2"
  ...
  foreach( $orders as $order ): ?>
    ...
    >
      ...
      <div class="ml-5 flex flex-col items-center justify-center w-1/4">
        ...
        <select class="p-1 rounded-lg hover:bg-gray-100" name="pesan[<?php echo $j ?>][spb]">
        ...
        <select class="p-1 rounded-lg hover:bg-gray-100" name="pesan[<?php echo $j ?>][spm]">
